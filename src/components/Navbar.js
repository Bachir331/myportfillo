        ...
        <nav>
          ...
          <Link to="/"><h1><span  className='spann'>{'<'}</span><span>{'BACHIR'}</span> <span className='spann'>{'/>'}</span></h1></Link>
            ...
            <div>
              ...
              <a  href="https://discord.gg/HdBK4wQXYQ"  target="_blank" rel="noopener noreferrer">
  <div className='Svg-Home-link'> 
<svg xmlns="http://www.w3.org/2000/svg" height="2em" width="2em" viewBox="0 0 640 512">
